...
// printf("__update_windowlist %d fw=%p\n", __LINE__, fw);
// void dump_windows();
// dump_windows();
	return;
}
...
{
	ScreenFocus = fw;
//printf("set_focus_window %d fw=%p LastScreenFocus=%p\n", __LINE__, fw, LastScreenFocus);
//void dump_windows();
//dump_windows();
...
//printf("set_last_screen_focus_window %d fw=%p\n", __LINE__, fw);
	return;
}
